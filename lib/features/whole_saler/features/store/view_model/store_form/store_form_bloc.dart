...
class StoreFormBloc extends Bloc<StoreFormEvent, StoreSignUpState> {
  StoreFormBloc() : super(StoreSignUpState.initial()) {
    ...
    on<StoreSignUpSubmitted>(_onStoreSignUpSubmitted);
    on<StoreSignUpReset>(_onStoreSignUpReset);
  }
  ...
  FutureOr<void> _onStoreSignUpSubmitted(StoreSignUpSubmitted event, emit) {
    state.copyWith(
      status: StoreFormStatus.submitting,
    );
  }

  FutureOr<void> _onStoreSignUpReset(StoreSignUpReset event, emit) {
    state.copyWith(
      status: StoreFormStatus.initial,
      storeName: '',
      ownerName: '',
